...
import com.capstone2.gymsbond.SlidingAdapter;
import com.capstone2.gymsbond.SlidingModel;
import com.capstone2.gymsbond.Water_MainActivity;
import com.capstone2.gymsbond.adapters.WorkoutData;
import com.capstone2.gymsbond.database.DatabaseOperations;
import com.capstone2.gymsbond.helpers.SqliteHelper;
import com.capstone2.gymsbond.utils.AppUtils;
...
public class MainFragment extends Fragment {
    ...
    private final int pStatus = 0;
    RelativeLayout rel_one, rel_two, rel_three;


    private final int[] myImageList = new int[]{R.drawable.banner_1, R.mipmap.banner_calculator, R.mipmap.banner_3, R.mipmap.img_reminder};
    ...
    public BroadcastReceiver progressReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                workoutDataList.get(workoutPosition).setProgress((float) doubleExtra);
...
//            this.recyclerView.setAdapter(this.adapter);
 ...
 RelativeLayout i_plus;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        txtProgress = inflate.findViewById(R.id.txtProgress);
        progressBar = inflate.findViewById(R.id.progressBar);
        waterLevelView = inflate.findViewById(R.id.waterLevelView);
        progressBar1 = inflate.findViewById(R.id.progress);


        percentScore1 = inflate.findViewById(R.id.percentScore);
        i_plus = inflate.findViewById(R.id.i_plus);
        dayleft = inflate.findViewById(R.id.daysLeft);
...
//        this.height = displayMetrics.heightPixels;
        ...
        rel_two = inflate.findViewById(R.id.rel_two);
        rel_three = inflate.findViewById(R.id.rel_three);
...
//            Toast.makeText(getActivity(), (CharSequence) "Empty", 1).show();
        ...
        this.progressBar1 = inflate.findViewById(R.id.progress);
