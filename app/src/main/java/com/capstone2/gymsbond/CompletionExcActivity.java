...
import com.capstone2.gymsbond.fragment.Workout;
...
//        startActivity(intent);
    ...
    public void shareConfirmDialog() {
        ...
        dialog.findViewById(R.id.shareit).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                dialog.dismiss();
                CompletionExcActivity.this.shareAllApp();
            }
        });
        dialog.findViewById(R.id.close_share).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                dialog.dismiss();
            }
        });
    ...
    public void a() {
        this.nativeAdContainer = findViewById(R.id.nativeAdContainer);
    ...
    public void allCompletionDialogCreate() {
        String str = "OK";
        String str2 = "Cancel";
        new Builder(this).setTitle("Congratulations !").setMessage("You have completed all 30 days workouts. To achieve consistency, please repeat the exercise from day one.").setPositiveButton(str, null).setNegativeButton(str2, null).setPositiveButton(str, new OnClickListener() {
        ...
        }).setNegativeButton(str2, new OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent = new Intent(CompletionExcActivity.this, Workout.class);
                intent.addFlags(603979776);
                CompletionExcActivity.this.startActivity(intent);
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.h = findViewById(R.id.shareimage_Congrats);
        this.f = findViewById(R.id.congrts_duration);
        this.g = findViewById(R.id.congrts_ExNo);
        this.congrts_complete = findViewById(R.id.congrts_complete);
