...
public class WidgetConfigureActivity extends Activity implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            RadioButton stepsButton = findViewById(R.id.stepsRadioButton);
            RadioButton distanceButton = findViewById(R.id.distanceRadioButton);
            RadioButton caloriesButton = findViewById(R.id.caloriesRadioButton);
