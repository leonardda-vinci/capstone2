...
import com.capstone2.gymsbond.interaction_chat.views.BigImageDialog
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                dataSnapshot.children.forEach {
                    ...
                    it.getValue(User.User::class.java)?.let {
...
class UserItem(val user: User.User, val context: Context) : Item<ViewHolder>() {
