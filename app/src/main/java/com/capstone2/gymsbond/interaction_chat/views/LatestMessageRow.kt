package com.capstone2.gymsbond.interaction_chat.views
...
import com.capstone2.gymsbond.interaction_chat.utils.DateUtils
...
class LatestMessageRow (val chatMessage: ChatMessage, val context: Context): Item<ViewHolder>() {
    var chatPartnerUser: User.User? = null
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                chatPartnerUser = p0.getValue(User.User::class.java)
