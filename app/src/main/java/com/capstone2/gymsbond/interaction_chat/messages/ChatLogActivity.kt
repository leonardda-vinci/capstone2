...
import com.capstone2.gymsbond.interaction_chat.utils.DateUtils.getFormattedTimeChatLog
...
class ChatFromItem(val text: String, val user: User.User, val timestamp: Long) : Item<ViewHolder>() {
...
class ChatToItem(val text: String, val user: User.User?, val timestamp: Long) : Item<ViewHolder>() {
