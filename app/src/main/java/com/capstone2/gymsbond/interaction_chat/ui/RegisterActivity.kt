package com.capstone2.gymsbond.interaction_chat.ui
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String?) {
        ...
        val user = if (profileImageUrl == null) {
            User.User(uid, name_edittext_register.text.toString(), null)
        } else {
            User.User(uid, name_edittext_register.text.toString(), profileImageUrl)
        }
