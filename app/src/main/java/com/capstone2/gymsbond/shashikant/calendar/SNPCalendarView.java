package com.capstone2.gymsbond.shashikant.calendar;
...
public class SNPCalendarView extends LinearLayout {
    ...
    public void init(Context context) {
        ...
        this.imageview_previous = this.view.findViewById(R.id.imageview_previous);
        this.imageview_next = this.view.findViewById(R.id.imageview_next);
        this.textview_month_title = this.view.findViewById(R.id.textview_month_title);
        ...
        this.gridview.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                SNPCalendarView.this.currentSelectedDate = CalendarAdapter.dayString.get(i);
