...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView imageView = view.findViewById(R.id.date_icon);
        ImageView imageView2 = view.findViewById(R.id.date_icon1);
        ImageView imageView3 = view.findViewById(R.id.date_icon2);
