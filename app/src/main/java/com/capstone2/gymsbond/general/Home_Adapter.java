...
import com.capstone2.gymsbond.BMR.bmr_calculator;
import com.capstone2.gymsbond.Body_Surface_Area_Calculator.C1376Body_Surface_Area_Calculator;
import com.capstone2.gymsbond.R;
import com.capstone2.gymsbond.alcohol.Alcohol_Calculator;
import com.capstone2.gymsbond.blood_donation.Blood_Donation_Calculator;
import com.capstone2.gymsbond.blood_pressure.BloodPressure_Calculator;
import com.capstone2.gymsbond.blood_volume.Blood_Volume_Calculator;
import com.capstone2.gymsbond.bmi.BMI_Calculator;
import com.capstone2.gymsbond.body_adiposity_index.Body_Adiposity_Index_Calculator;
import com.capstone2.gymsbond.body_fat.Bodyfat_Calculator;
import com.capstone2.gymsbond.body_frame_size.Body_Frame_Size_Calculator;
import com.capstone2.gymsbond.calories_burn.Calories_burn_Calculator;
import com.capstone2.gymsbond.calories_intake.Daily_Calories_Intake_Calculator;
import com.capstone2.gymsbond.chest_hip_ratio.Chest_Hip_Ratio_Calculator;
import com.capstone2.gymsbond.child_growth.Child_Growth_Calculator;
import com.capstone2.gymsbond.children_height_growth.Children_Height_Growth_Prediction_Calculator;
import com.capstone2.gymsbond.cholestrol.Cholestrol_Calculator;
import com.capstone2.gymsbond.daily_water.Daily_WaterIntake_Calculator;
import com.capstone2.gymsbond.heart_rate.Heart_Rate_Calculator;
import com.capstone2.gymsbond.ideal_body_weight.Ideal_Body_Weight_Calculator;
import com.capstone2.gymsbond.lean_body_mass.Lean_Body_Mass_Calculator;
import com.capstone2.gymsbond.menstrual_and_ovulation.Menstrual_Ovulation_Calculator;
import com.capstone2.gymsbond.pregnancy_due_date.Pregnancy_Due_Date_Calculator;
import com.capstone2.gymsbond.smoking_risk.Smoking_Risk_Calculator;
import com.capstone2.gymsbond.sugar.Sugar_calculator;
import com.capstone2.gymsbond.trademill.Trademill_Calculator;
import com.capstone2.gymsbond.utils.TypefaceManager;
import com.capstone2.gymsbond.waist_height_ratio.Waist_Height_Ratio_Calculator;
import com.capstone2.gymsbond.waist_hip_ratio.Waist_Hip_Ratio_Calculator;
...
public class Home_Adapter extends RecyclerView.Adapter<Home_Adapter.MyRestaurant_ViewHolder> implements Filterable {
    ...
    public class MyRestaurant_ViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyRestaurant_ViewHolder(View view) {
            super(view);
            this.tv_title_home = view.findViewById(R.id.tv_title_home);
            this.image_home = view.findViewById(R.id.image_home);
            this.rl_home = view.findViewById(R.id.rl_home);
...
//            gradientDrawable.setColor(Color.parseColor(sb.toString()));
            ...
            myRestaurant_ViewHolder.rl_home.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    int i = Home_Adapter.this.all_videohistoryArrayList.get(((Integer) view.getTag()).intValue()).f2614id;
                    if (i == 0) {
            ...
            public FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charSequence == null || charSequence.length() == 0) {
                    ...
                    for (int i = 0; i < Home_Adapter.this.allVideo.size(); i++) {
                        ...
                        if (all_Home.title.toLowerCase().contains(charSequence.toString().toLowerCase())) {
                            StringBuilder sb = new StringBuilder();
                            sb.append("pos->");
                            sb.append(i);
