    ...
    public long insertExcALLDayData() {
        ...
        try {
            ...
            for (int i = 1; i <= 30; i++) {
                ...
                contentValues.put(DatabaseHelper.e, 0.0d);
